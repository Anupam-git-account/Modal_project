<template>
  <div>
     <div v-if="loading" class="loader-overlay">
      <div class="loader">Loading...</div> <!-- Simple text-based loader or replace with an actual spinner -->
    </div>
    <div class="row">
      <div class="col-md-10">
        <div class="question-container">
          ...
          <p class="question-text">
            <strong
              >Question {{ currentIndex + 1 }} of {{ questions.length }}</strong
            >
          </p>
          <p class="question-text">
      ...
      <div class="col-md-2">
        <div class="questions-container-wrapper">
          <div class="questions-container">
            ...
            >
              <div style="display: flex; align-items: center">
                <div class="status-box submitted" title="Submitted"></div>
              ...
              <div style="display: flex; align-items: center">
                <div class="status-box not-answered" title="Not Answered"></div>
                <p style="color: black; font-size: 10px; margin-left: 5px">
                  Not yet Submitted
                </p>
              </div>
              ...
              <div style="display: flex; align-items: center">
                <div class="status-box present" title="Present Question"></div>
                <p style="color: black; font-size: 10px; margin-left: 5px">
                  Present Question
                </p>
              </div>
    ...
    <div v-if="currentIndex === questions.length - 1">
      <button class="submit-button" @click="submitAnswers" :disabled="loading">Submit</button>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      questions: [
        {
          question:
            "What is your favorite programming language? What is your favorite programming language? What is your favorite programming language?What is your favorite programming language? ",
          type: "single-choice",
        ...
        {
          question:
            "What tools do you use to monitor and analyze the performance of your applications?",
          type: "open-ended",
        },
        {
      ...
      loading: false, // Loading state to show while the questions are being fetched
    };
  },
  computed: {
    currentQuestion() {
